...
def generarMenu(usuario):
    ...
    with st.sidebar:
        ...
        st.page_link("inicio.py", label="Inicio", icon="🏠")  # Use a Unicode emoji for the home icon
        st.subheader("Tableros")
        st.page_link("pages/pagina1.py", label="Descargar y procesar", icon="📥")  # Use a Unicode emoji for download
        st.page_link("pages/pagina2.py", label="Chatbot", icon="🤖")  # Use a Unicode emoji for chatbot
        st.page_link("pages/pagina3.py", label="Informe", icon="📄")  # Use a Unicode emoji for report
